...
from AlfaazMusic.utils.database import get_authuser_names, get_cmode
from AlfaazMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AlfaazMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Alfaaz.stop_stream(message.chat.id)
    except:
        pass
